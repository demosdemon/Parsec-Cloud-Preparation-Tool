...
(New-Object System.Net.WebClient).DownloadFile("https://github.com/demosdemon/Parsec-Cloud-Preparation-Tool/archive/master.zip","$ENV:UserProfile\Downloads\Parsec-Cloud-Preparation-Tool.zip")  
